...
CREATE TABLE `estadocivil` (
  `CodEstadoCivil` int unsigned NOT NULL,
  `DescricaoEstadoCivil` varchar(25) DEFAULT NULL,
...
INSERT INTO `estadocivil` VALUES (0,'Não Informado'),(1,'Solteiro'),(3,'Casado'),(5,'Viúvo'),(7,'Separado Judicialmente'),(9,'Divorciado');
