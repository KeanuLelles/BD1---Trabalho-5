...
CREATE TABLE `genero` (
  `CodGenero` int unsigned NOT NULL,
  `DescricaoGenero` varchar(25) NOT NULL,
...
INSERT INTO `genero` VALUES (0,'Não Informado'),(2,'Masculino'),(4,'Feminino');
...
-- Dump completed on 2024-07-24 17:31:03
